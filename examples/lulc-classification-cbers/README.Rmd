...
In this example, `bdcrrm-api` is used for the reproducible production of maps of **L**and **U**se and **L**and **C**over (LULC) using the R programming language and the [SITS analytical package](github.com/e-sensing/sits).
...
The results are the same, indicating that even when run in different environments, the controls offered by `bdcrrm-api` help reproduce the results.
