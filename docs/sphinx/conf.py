...
"""Configuration file for the Brazil Data Cube Reproducible Research Management CLI documentation.
...
#import os
#
#BDCRRM_CLI_EXAMPLE_URL = os.getenv('BDCRRM_CLI_EXAMPLE_URL', None)
#'''
