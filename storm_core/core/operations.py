...
class ReproducibleOperations:
    ...
    def _check_outdated_executions(self):
        ...
        outdated_executions = list(self._execution_indexer.search.faceted.outdated_execution_compendia())
    ...
    def execute(self, execution_plan: ExecutionPlan):
        ...
        return [
            self._execution_indexer.index_execution(ExecutionCompendium(
                command=ec.command,
    ...
    def rerun(self, reproducible_storage):
        ...
        execution_plan = GraphMutator.mutate_graph_to_execution_plan_by_outdated_compendia(_graph, outdated_compendia,
        ...
        if execution_plan:
            ...
            execution_result = [
                self._execution_indexer.edit_indexed_execution(ExecutionCompendium(
                    command=ec.command,
                    name=ec.execution_id,
                    metadata=ec.execution_results["metadata"],
                    compendium_package=ec.execution_results["compendium_package"]
    ...
    def reproduce(self,
        ...
        _graph = self._execution_indexer.graph_manager.graph
        execution_compendia = list(self._execution_indexer.search.query.execution_compendium())

        execution_plan = GraphMutator.mutate_index_graph_to_compendia_job_graph(_graph,
                                                                                reproducible_storage,
                                                                                execution_compendia)

        # reproducing
        self._execution_engine.reproduce(execution_plan, required_data_objects, required_environment_variables)
